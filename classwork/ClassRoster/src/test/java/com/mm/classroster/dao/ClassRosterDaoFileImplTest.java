...
public class ClassRosterDaoFileImplTest extends TestCase{
    
    ClassRosterDao testDao;
    
    public ClassRosterDaoFileImplTest(String testName) {
        super(testName);
    }
    ...
    public void testRemoveStudent() throws Exception {
        ...
        assertTrue("All students should NOT include Charles.", allStudents.contains(secondStudent));    
