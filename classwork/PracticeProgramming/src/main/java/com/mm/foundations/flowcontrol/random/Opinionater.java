 ...
 * date: 07/14/2021
 * purpose: Java Exercise 5.2 Opinionater
 */
...
public class Opinionater {
    public static void main(String[] args) {
        ...
        // The bug is that 5 is exclusive, making the range 0-4.
        // case 5 will never be entered
        // Using 6 instead will make it possible
